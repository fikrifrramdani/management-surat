...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 style="margin-top: 5px">Disposisi Surat</h3>
	</div>
</div>
		...
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				<tr>
					...
					<td><b><input type="text" name="kpd_yth" autofocus tabindex="1" required value="<?php echo $kpd_yth; ?>" style="width: 400px" class="form-control"></b></td>
				</tr>
				<tr>
					<td width="20%">Isi Disposisi</td>
					<td><b><textarea name="isi_disposisi" tabindex="2" required style="width: 400px; height: 60px" class="form-control"><?php echo $isi_disposisi; ?></textarea></b></td>
				</tr>
				<tr>
					<td colspan="2">
		...
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				<tr>
					...
					<td><b>
							<select name="sifat" class="form-control" tabindex="3" style="width: 200px" required>
				...
				<tr>
					...
					<td><b><input type="text" tabindex="4" name="batas_waktu" required value="<?php echo $batas_waktu; ?>" id="tgl_surat" style="width: 100px" class="form-control"></b></td>
				</tr>
				<tr>
					<td width="20%">Catatan</td>
					<td><b><input type="text" tabindex="5" name="catatan" value="<?php echo $catatan; ?>" style="width: 400px" class="form-control"></b></td>
				</tr>
			</table>
		</div>
