		...
		<div class="col-lg-6">
			<table class="table-form">
				<tr>
					...
					<td><b><input type="text" name="kode" tabindex="5" id="kode_surat" required value="<?php echo $kode; ?>" style="width: 100px" class="form-control"></b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><b><input type="file" name="file_surat" tabindex="8" class="form-control" style="width: 200px"></b></td>
				</tr>
				<tr>
					<td width="20%">Keterangan</td>
					<td><b><input type="text" name="ket" value="<?php echo $ket; ?>" tabindex="9" style="width: 400px" class="form-control"></b></td>
				</tr>
			</table>
		</div>
