...
<head>
	...
	<head>
		<title>NMS (Nyde Manajemen Surat)</title>
...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				<span class="navbar-brand"><strong style="font-family: verdana;">NMS</strong></span>
			...
			<div class="navbar-collapse collapse" id="navbar-main">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" id="themes"><i class="icon-th-list icon-white"> </i> Referensi <span class="caret"></span></a>
					...
					<?php } ?>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" id="themes"><i class="icon-file icon-white"> </i> Agenda <span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="themes">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-user icon-white">
	...
	<div class="container">
		...
		<div class="span12 well well-sm">
			<center>
				<h4 style="font-weight: bold">NMS (Nyde Manajemen Surat)</a></h4>
